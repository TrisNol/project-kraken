...
class RelationshipManager:
        ...
        try:
            with driver.session(database=self.neo4j_database) as session:
                for doc in documents:
                    ...
                    if doc_type == 'JIRA':
                        stats['jira_to_jira'] += self._create_jira_relationships(session, meta, links)
                        stats['jira_to_confluence'] += self._create_jira_to_confluence_relationships(session, meta, links)
                    elif doc_type == 'CONFLUENCE':
                        stats['confluence_to_jira'] += self._create_confluence_to_jira_relationships(session, meta, links)
                        stats['confluence_to_confluence'] += self._create_confluence_relationships(session, meta, links)
                    elif doc_type == 'GITHUB':
                        stats['github_to_jira'] += self._create_github_to_jira_relationships(session, meta, links)
                        stats['github_to_confluence'] += self._create_github_to_confluence_relationships(session, meta, links)
                        stats['github_to_github'] += self._create_github_relationships(session, meta, links)
        finally:
            driver.close()
    ...
    def _create_jira_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
    ...
    def _create_jira_to_confluence_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
    ...
    def _create_confluence_to_jira_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
    ...
    def _create_confluence_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
    ...
    def _create_github_to_jira_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
    ...
    def _create_github_to_confluence_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
    ...
    def _create_github_relationships(self, session, source_meta: Dict[str, Any], links: Dict[str, Any]) -> int:
